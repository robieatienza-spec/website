...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[220vh] sm:h-[300vh] pb-20 sm:pb-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <motion.div
        style={{
          rotateX,
